...
The Mermaid configuration parameters can also be set on a specific page. In this case, the global parameter would be overwritten by the local one. See [Mermaid]({{< relref "example/shortcodes/mermaid.md" >}}) for additional documentation.
